...
void Init ()
{
    ...
    // 舵机PWM初始化
   // gtm_pwm_init(ATOM0_CH1_P33_9, 50, 625); // 550最右, 625中值, 700最左,旧车
    gtm_pwm_init(ATOM0_CH1_P33_9, 80, 1160); // 1040最右, 1160中值, 1280最左,新车
    // 编码器初始化
...
//            }
            ...
            */
            ...
            // 新版舵机
            steer_pwm = 1160 + atan(slope) * 140;
            if (steer_pwm > 1280)
                steer_pwm = 1280;
            else if (steer_pwm < 1040)
                steer_pwm = 1040;
